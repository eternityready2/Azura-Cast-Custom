<?php return array (
  ...
  array (
    ...
    array (
      ...
      'GeoLite version "%{version}" is currently installed.' => 'GeoLite versie "%{version}" is momenteel geïnstalleerd.',
      ...
      'Yes' => 'Ja',
      'No' => 'Nee',
      'First Connected' => 'Eerste verbonden',
      'Latest Update' => 'Laatste update',
      'In order to install RSAS:' => 'Om RSAS te installeren:',
      ...
      'If using the paid version of RSAS, upload the license key file separately.' => 'Als de betaalde versie van RSAS wordt gebruikt, upload dan het licentiesleutelbestand apart.',
      ...
      'Generate Access Code' => 'Genereer toegangscode',
      ...
      'For simple updates where you want to keep your current configuration, you can update directly via your web browser. You will be disconnected from the web interface and listeners will be disconnected from all stations.' => 'Voor eenvoudige updates waar u uw huidige configuratie wilt behouden, kunt u rechtstreeks via uw webbrowser updaten. De verbinding met de webinterface wordt verbroken en luisteraars zullen van alle stations worden losgekoppeld.',
      ...
      'Files played immediately:' => 'Onmiddellijk afgespeelde bestanden:',
      'Error queueing files:' => 'Fout wachtrij bestanden:',
      'Files queued for playback:' => 'Bestanden in de afspeelwachtrij:',
      'Files removed:' => 'Bestanden verwijderd:',
      'Error removing files:' => 'Fout bij het verplaatsen van bestanden:',
      'Back' => 'Terug',
      'Move to Directory' => 'Verplaats naar map',
      'Directory' => 'Map',
      'Error moving files:' => 'Fout bij het verplaatsen van bestanden:',
      ...
      'Error removing episodes:' => 'Fout bij het verwijderen van afleveringen:',
      ...
      'Error removing broadcasts:' => 'Fout bij verwijderen van uitzendingen:',
      ...
      'Found under the settings page for the corresponding RadioReg station.' => 'Gevonden onder de instellingenpagina voor het bijbehorende RadioReg-station.',
      'Bot Token' => 'Bot Token',
      ...
      'Generic Web Hooks' => 'Algemene Webhooken',
      'Analytics' => 'Analyses',
      ...
      'GroupMe Chat Message' => 'GroupMe Chat Bericht',
      ...
      'Google Analytics V4 Integration' => 'Google Analytics V4 integratie',
