<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Account Details' => 'Paramètres du compte',
      ...
      'A passkey has been selected. Submit this form to add it to your account.' => 'Une clé d\'accès a été sélectionnée. Envoyez ce formulaire pour l\'ajouter à votre compte.',
      ...
      'Backup times are always in UTC.' => 'Les heures de sauvegarde sont toujours en UTC.',
      ...
      'This will be the file name for your backup, include the extension for file type you wish to use. Leave blank to have a name generated automatically.' => 'Ce sera le nom de fichier de votre sauvegarde, incluez l\'extension du type de fichier que vous souhaitez utiliser. Laissez vide pour faire générer un nom automatiquement.',
      'Supported file formats:' => 'Formats de fichiers acceptés :',
      'ZStandard compression' => 'Compression ZStandard',
      ...
      'Custom Branding' => 'Personnalisation de l\'interface graphique',
      ...
      'Branding Settings' => 'Paramètres de l\'interface graphique',
      ...
      'Clear Server Cache' => 'Vider le cache du serveur',
      'Clear Client Cache' => 'Vider le cache du client',
      ...
      'Client-side cache cleared!' => 'Cache côté client effacé !',
      'Details' => 'Détails',
      'Debug' => 'Debug',
      'Info' => 'Informations',
      'Notice' => 'Remarque',
      ...
      'GeoLite version "%{version}" is currently installed.' => 'La version "%{version}" de GeoLite est actuellement installée.',
      'Remove GeoLite license key?' => 'Supprimer la clé de licence GeoLite ?',
      ...
      'System Maintenance' => 'Configuration système',
      ...
      'Stations' => 'Stations',
      'Connected AzuraRelays' => 'AzuraRelays connectés',
      'Third-Party Software' => 'Logiciel tiers',
      ...
      'MaxMind GeoLite IP Database' => 'Base de données MaxMind GeoLite IP',
      ...
      'Install RSAS' => 'Installer RSAS',
      'Rocket Streaming Audio Server (RSAS) is a closed-source alternative to Icecast as a broadcasting frontend. As it is proprietary, AzuraCast cannot distribute it, but you can install it via this page. If installed, stations can select it as their broadcasting software.' => 'Rocket Streaming Audio Server (RSAS) est une alternative à Icecast en tant que logiciel de diffusion. Ce logiciel est propriétaire, AzuraCast ne peut pas le distribuer, mais vous pouvez l\'installer via cette page. S\'il est installé, les stations peuvent le sélectionner comme leur logiciel de diffusion.',
      'In order to install RSAS:' => 'Pour installer RSAS :',
      'Download the proper statically linked binary for your platform from the RSAS download page:' => 'Téléchargez le bon binaire pour votre plateforme à partir du site de RSAS :',
      'Download RSAS' => 'Télécharger RSAS',
      ...
      'If using the paid version of RSAS, upload the license key file separately.' => 'Si vous utilisez la version payante de RSAS, envoyez le fichier de clé de licence séparément.',
      'RSAS is not currently installed on this installation.' => 'RSAS n\'est actuellement pas installé sur cette machine.',
      'Uninstall' => 'Désinstaller',
      'License Key' => 'Clé de licence',
      'License key is currently installed.' => 'La clé de licence est actuellement installée.',
      'License key is not is not currently installed.' => 'La clé de licence n\'est pas installée actuellement.',
      'Remove License Key' => 'Supprimer la clé de licence',
      'RSAS version "%{version}" is currently installed.' => 'La version "%{version}" de RSAS est actuellement installée.',
      'Remove RSAS installation?' => 'Supprimer l\'installation RSAS ?',
      'Remove RSAS license key?' => 'Supprimer la clé de licence RSAS ?',
      'Debugging' => 'Débogage',
      'Temporarily Disable Synchronization Tasks' => 'Désactiver temporairement les tâches de synchronisation',
      'Prevents background tasks from automatically running. Tasks are disabled automatically when restoring a backup to allow media to be re-uploaded.' => 'Empêche les tâches d\'arrière-plan de s\'exécuter automatiquement. Les tâches sont désactivées automatiquement lors de la restauration d\'une sauvegarde pour permettre aux médias d\'être réimportés.',
      'Settings' => 'Paramètres',
      ...
      'Set to "Yes" to always use "https://" secure URLs, and to automatically redirect to the secure URL when an insecure URL is visited (HSTS).' => 'Définissez sur "Oui" pour toujours utiliser l\'URL sécurisé "https://", et pour rediriger automatiquement vers l\'URL sécurisée lorsqu\'une URL non sécurisée est visitée (HSTS).',
      ...
      'Remove Shoutcast 2 DNAS?' => 'Supprimer Shoutcast 2 DNAS ?',
      'Manage' => 'Gérer',
      'Clone' => 'Dupliquer',
      'Enable' => 'Activer',
      'Broadcasting' => 'Diffusion',
      'AutoDJ' => 'AutoDJ',
      'Disable station?' => 'Désactiver la station ?',
      ...
      'The maximum bitrate in which the station allowed to broadcast at, in Kbps. 0 for unlimited.' => 'Le débit maximum dans lequel la station est autorisé à diffuser, en Kbps. 0 pour illimité.',
      'Maximum Mounts' => 'Points de montage maximum',
      'The maximum number of mount points allowed. 0 for unlimited.' => 'Le nombre maximum de points de montage autorisé. 0 pour illimité.',
      'Maximum HLS Streams' => 'Maximum de flux HLS',
      'The maximum number of HLS streams allowed. 0 for unlimited.' => 'Le nombre maximum de flux HLS autorisé. 0 pour illimité.',
      ...
      'Apply audio processors (like compressors, limiters, or equalizers) to your stream to create a more uniform sound or enhance the listening experience. Processing requires extra CPU resources, so it may slow down your server.' => 'Appliquez des processeurs audio (comme les compresseurs, les limiteurs ou les égaliseurs) à votre flux pour créer un son plus uniforme ou améliorer l\'expérience d\'écoute. Le traitement nécessite des ressources CPU supplémentaires, ce qui peut ralentir votre serveur.',
      'Learn More about Post-processing CPU Impact' => 'En savoir plus sur l\'impact du post-traitement sur leprocesseur',
      'Enable AutoCue (Beta)' => 'Activer l\'AutoCue (Beta)',
      'AutoCue analyzes your music and automatically calculates cue points, fade points, and volume levels for a consistent listening experience.' => 'AutoCue analyse votre musique et calcule automatiquement les points de repère, les points de fondu et les niveaux de volume pour une expérience d\'écoute cohérente.',
      'Learn more about AutoCue' => 'En savoir plus sur l\'AutoCue',
      'Enable ReplayGain' => 'Activer le ReplayGain',
      'Calculate and use normalized volume level metadata for each track.' => 'Calculer et utiliser des métadonnées de niveau de volume normalisées pour chaque piste.',
      ...
      'Stereo Tool is an industry standard for software audio processing. For more information on how to configure it, please refer to the' => 'Stereo Tool est un standard de l\'industrie parmi les logiciels de traitement audio. Pour plus d\'informations et pour savoir comment le configurer, référez-vous à la',
      'Stereo Tool documentation.' => 'Documentation de Stereo Tool.',
      'Stereo Tool License Key' => 'Clé de licence de Stereo Tool',
      ...
      'Upload Stereo Tool Configuration' => 'Importer la configuration de Stereo Tool',
      'Upload a Stereo Tool configuration file from the "Broadcasting" submenu in the station profile.' => 'Importez un fichier de configuration de Stereo Tool dans le menu "Diffusion" du profil de la station.',
      'Advanced Configuration' => 'Configuration avancée',
      'Advanced' => 'Avancé',
      'Share Encoders Between Streams' => 'Partager les encodeurs entre les flux',
      'If you have multiple streams that broadcast in the same format and bitrate, enabling this may significantly improve CPU consumption. Disable this setting if you encounter issues with shared encoding.' => 'Si vous avez plusieurs flux qui diffusent dans le même format et le même débit, l\'activation peut considérablement améliorer la consommation du processeur. Désactivez ce paramètre si vous rencontrez des problèmes avec l\'encodage partagé.',
      ...
      'Always Write Playlists to Liquidsoap' => 'Écrire toujours les playlists à Liquidsoap',
      'By default, all playlists are written to Liquidsoap as a backup in case the normal AutoDJ fails. This can affect CPU load, especially on startup. Disable to only write essential playlists to Liquidsoap.' => 'Par défaut, toutes les playlists sont écrites dans Liquidsoap comme sauvegarde au cas où l\'AutoDJ normal échoue. Cela peut affecter la charge du processeur, en particulier au démarrage. Désactiver pour écrire uniquement des playlists essentielles à Liquidsoap.',
      ...
      'Use Rocket Streaming Audio Server (RSAS) on this server.' => 'Utilisez Rocket Streaming Audio Server (RSAS) sur ce serveur.',
      ...
      'HTTP Live Streaming (HLS) is a new adaptive-bitrate technology supported by some clients. It does not use the standard broadcasting frontends.' => 'HTTP Live Streaming (HLS) est une nouvelle technologie de débit adaptative soutenue par certains clients. Il n\'utilise pas les fronts de radiodiffusion standard.',
      ...
      'Genre' => 'Genre',
      'The primary genre this station plays, such as "rock", "electronic", or "talk".' => 'Le genre principal que joue cette station, tel que "rock", "électronique" ou "talk".',
      ...
      'Note that Stereo Tool can be resource-intensive for both CPU and Memory. Please ensure you have sufficient resources before proceeding.' => 'Stereo Tool sollicite fortement les performances du processeur et la RAM. Assurez-vous d\'avoir suffisamment de ressources disponibles avant de l\'activer.',
      'Stereo Tool is not free software, and its restrictive license does not allow AzuraCast to distribute the Stereo Tool binary.' => 'Stereo Tool n\'est pas un logiciel libre. Sa licence restrictive ne permet pas à AzuraCast de distribuer le binaire de Stéréo Tool.',
      'In order to install Stereo Tool:' => 'Pour installer Stéréo Tool :',
      'Download the appropriate binary from the Stereo Tool downloads page:' => 'Téléchargez le binaire approprié à partir de la page de téléchargement de Stereo Tool :',
      'Stereo Tool Downloads' => 'Téléchargements de Stereo Tool',
      ...
      'Stereo Tool is not currently installed on this installation.' => 'Stereo Tool n\'est pas actuellement installé sur cette machine.',
      'Stereo Tool version %{version} is currently installed.' => 'La version %{version} de Stereo Tool est actuellement installée.',
      'Uninstall Stereo Tool?' => 'Désinstaller Stereo Tool ?',
      ...
      'New Login Link' => 'Nouveau lien de connexion',
      'Link Type' => 'Type de lien',
      'Link Expiration (Minutes)' => 'Expiration du lien (minutes)',
      'Description/Comments' => 'Description / Commentaires',
      'Create New Login Link' => 'Créer un nouveau lien de connexion',
      'Reset Password' => 'Réinitialiser le mot de passe',
      'Magic Login Link' => 'Connexion par lien magique',
      'New Login Link Created' => 'Nouveau lien de connexion créé',
      'Important: copy the address before continuing!' => 'Important : copiez la clé ci-dessous avant de continuer !',
      'Each login link is only usable once.' => 'Chaque lien de connexion n\'est utilisable qu\'une seule fois.',
      ...
      'Avatars are retrieved based on your e-mail address from the %{service} service. Click to manage your %{service} settings.' => 'Les avatars sont récupérés à partir de votre adresse mail à partir sur le service %{service}. Cliquez pour gérer vos paramètres %{service}.',
      'Enabled' => 'Activé',
      ...
      'Page' => 'Page',
      'Go' => 'Aller',
      'Powered by' => 'Fièrement propulsé par',
      ...
      'Required' => 'Requis',
      'This setting can result in excessive CPU consumption and should be used with caution.' => 'Ce paramètre peut entraîner une consommation excessive du CPU et doit être utilisé avec prudence.',
      'High CPU' => 'Élévation du CPU',
      'Seek' => 'Chercher',
      ...
      'Album' => 'Album',
      'Live' => 'Direct',
      'Open Popup Player' => 'Ouvrir le lecteur PIP',
      'Podcasts' => 'Podcasts',
      'RSS' => 'RSS',
      'Explicit' => 'Explicite',
      'Episode' => 'Épisode',
      ...
      'Web DJ connected!' => 'WebDJ connecté !',
      'An error occurred with the Web DJ socket.' => 'Une erreur s\'est produite avec le socket WebDJ.',
      ...
      'This will be shown on public player pages if the station is offline. Leave blank to default to a localized version of &quot;%{message}&quot;.' => 'Ce message sera affiché sur les pages publiques de la station si la diffusion est hors ligne. Laissez vide pour afficher un message localisé de "%{message}".',
      ...
      'Preview Changes' => 'Aperçu des changements',
      'Media File' => 'Fichier média',
      'Proposed Changes' => 'Modifications proposées',
      'Metadata:' => 'Métadonnées :',
      'Extra Metadata:' => 'Métadonnées suplémentaires :',
      'Playlists:' => 'Playlists :',
      'Add to:' => 'Ajouter à :',
      'Remove from:' => 'Retirer de :',
      'Custom Fields:' => 'Champs personnalisés :',
      'No changes' => 'Aucun changement',
      'Proceed with Import' => 'Procéder à l\'importation',
      ...
      'Import a file that was previously exported by this page, and AzuraCast will update any custom code sections with the custom code contained in your export file. Note that this will remove any existing code you have in these sections.' => 'Importer un fichier qui a été précédemment exporté par cette page pour AzuraCast mette à jour toutes les sections de code personnalisé avec le code personnalisé contenu dans votre fichier d\'exportation. Notez que cela supprimera tout code existant que vous avez saisi dans ces sections.',
      ...
      'Length' => 'Durée',
      'Modified' => 'Modifié',
      'Uploaded Time' => 'Date et heure de l\'envoi',
      'Last Processed Time' => 'Date et heure du dernier traitement',
      'Home' => 'Accueil',
      ...
      'Custom Fading: Start Next (seconds)' => 'Fondu personnalisé : Démarrage suivant (secondes)',
      'Seconds from the start of the song that the next song should begin when fading. Leave blank to use the system default.' => 'Secondes du début de la chanson que la chanson suivante devrait commencer lors du fondu. Laissez vide pour utiliser le système par défaut.',
      ...
      'Set Fade Start Next' => 'Définir le fondu du démarrage suivant',
      'Set Fade In' => 'Point d\'entrée en fondu',
      'Set Fade Out' => 'Point de sortie en fondu',
      'This playlist is assigned from the folder %{folder}. Click to view tracks in playlist' => 'Cette playlist est assignée au dossier %{folder}. Cliquez pour voir les fichiers dans la playlist',
      ...
      'Reprocess' => 'Retraiter',
      'Remove any extra metadata (fade points, cue points, etc.) from the selected media' => 'Supprimer toutes les métadonnées supplémentaires (points de fondu, points cue, etc.) des médias sélectionnés',
      'Clear Extra Metadata' => 'Effacer les métadonnées supplémentaires',
      ...
      'Extra metadata cleared for files:' => 'Métadonnées supplémentaires effacées pour les fichiers :',
      'Delete %{num} media files?' => 'Supprimer %{num} fichier(s) média ?',
      ...
      '%{num} directories' => '%{num} dossiers',
      '%{num} files' => '%{num} fichiers',
      'Overview' => 'Vue d\'ensemble',
      'Edit Station Settings' => 'Paramètres de la station',
      'Branding' => 'Interface graphique',
      'Public Player' => 'Player publique',
      'Media' => 'Médias',
      ...
      'You can set a custom URL for this stream that AzuraCast will use when referring to it on the web interface and in the Now Playing API return data. Leave empty to use the default value.' => 'Vous pouvez définir une URL personnalisée pour ce flux qu\'Azuracast utilisera lors de la référence sur l\'interface Web et dans les données de retour de l\'API Now Playing. Laissez vide pour utiliser la valeur par défaut.',
      'Custom Frontend Configuration' => 'Configuration personnalisée du front-end',
      'You can include any special mount point settings here, in either JSON { key: \'value\' } format or XML &lt;key&gt;value&lt;/key&gt;' => 'Vous pouvez inclure ici des paramètres spéciaux sur le point de montage au format JSON { clé: \'valeur\' } ou XML <clé>valeur</clé>;',
      ...
      'AutoDJ Bitrate (kbps)' => 'Débit de l\'AutoDJ (Kb/s)',
      ...
      'Enable to allow listeners to select and play from this mount point on this station\'s public pages, including embedded widgets.' => 'Activer pour permettre aux auditeurs de sélectionner et de jouer à partir de ce point de montage sur les pages publiques de cette station, y compris des widgets intégrés.',
      ...
      'Prioritize over listener requests.' => 'Prioriser au dessus des demandes d\'écoute.',
      ...
      'An optional description to help identify this playlist.' => 'Une description facultative pour aider à identifier cette playlist.',
      'Source' => 'Source',
      ...
      'Playlists with larger number weights (i.e. 25) play more frequently than playlists with smaller number weights (i.e. 1).' => 'Les listes de lecture avec un poids plus élevé (ex. 25) sont jouées plus fréquemment que les listes de lecture avec des poids plus faibles (ex. 1).',
      ...
      'Move to Bottom' => 'Déplacer vers le bas',
      'Move Down' => 'Descendre',
      'Move Up' => 'Monter',
      'Move to Top' => 'Déplacer vers le haut',
      ...
      'Bulk Edit Episodes' => 'Modifier les épisodes en vrac',
      'Episodes updated:' => 'Épisode(s) mis à jour :',
      'Error updating episodes:' => 'Erreur en mettant à jour l\'/les épisode(s) :',
      ...
      'The date and time when the episode should be published.' => 'La date et l\'heure à laquelle l\'épisode doit être publié.',
      ...
      'Delete %{num} episodes?' => 'Supprimer %{num} épisode(s) ?',
      'Episodes removed:' => 'Épisode(s) supprimé(s) :',
      'Error removing episodes:' => 'Erreur en supprimant l\'/les épisode(s) :',
      ...
      'Indicates the presence of explicit content (explicit language or adult content). Apple Podcasts displays an Explicit parental advisory graphic for your podcast if turned on. Podcasts containing explicit material aren\'t available in some Apple Podcasts territories.' => 'Indique la présence d\'un contenu explicite (langage explicite ou contenu adulte). Apple Podcasts affiche un "Explicit parental advisory" sur votre épisode s\'il est activé. Les épisodes contenant du contenu explicite ne sont pas disponibles dans certains territoires via Apple Podcasts.',
      'Enable Open Podcast Prefix Project (OP3) Analytics Support' => 'Activer la prise en charge de Open Podcast Prefix Project (OP3)',
      'Enable to prefix all podcast episode URLs with the OP3 analytics URL, allowing you to view statistics about your podcast audience via the OP3 service.' => 'Activer pour préfixer toutes les URL d\'épisode de podcast avec l\'URL d\'analyse OP3, vous permettant d\'afficher des statistiques sur l\'audience de votre podcast grâce au service OP3.',
      ...
      'Password:' => 'Mot de passe :',
      'Port' => 'Port',
      'Some clients may require that you enter a port number that is either one above or one below this number.' => 'Certains clients peuvent exiger que vous saisissiez un numéro de port qui est soit un au-dessus ou un en dessous de ce numéro.',
      'Hide Credentials' => 'Cacher les crédits',
      'Show Credentials' => 'Afficher les identifiants',
      ...
      'Skip current song?' => 'Passer la musique actuelle ?',
      'Disconnect current streamer?' => 'Déconnecter le diffuseur actuel ?',
      'Embed Widgets' => 'Widgets à intégrer',
      ...
      'Use this form to send a manual metadata update. Note that this will override any existing metadata on the stream.' => 'Utilisez ce formulaire pour envoyer une mise à jour manuelle des métadonnées. Notez que cela remplacera toutes les métadonnées existantes sur le flux.',
      'Metadata updated.' => 'Métadonnées mises à jour.',
      'Enable feature?' => 'Activer cette fonctionnalité ?',
      'Disable feature?' => 'Désactiver cette fonctionnalité ?',
      'Player Embed Widget Builder' => 'Constructeur de Widgets à intégrer',
      'Widget Builder' => 'Widget à intégrer',
      'Reset All To Defaults' => 'Réinitialiser',
      'Widget Type' => 'Type de widget',
      'Theme' => 'Thème',
      'Player Customization' => 'Customisation du lecteur',
      'Appearance' => 'Apparence',
      'Primary Color' => 'Couleur principale',
      'Background Color' => 'Couleur de fond',
      'Text Color' => 'Couleur du texte',
      'Show Album Art' => 'Afficher la pochette d\'album',
      'Rounded Corners' => 'Coins arrondis',
      'Functionality' => 'Fonctionnement',
      'Initial Volume' => 'Volume initial',
      'Autoplay' => 'Lecture automatique',
      'Show Volume Controls' => 'Afficher le réglage du volume',
      'Show Track Progress' => 'Afficher la progresssion du titre',
      'Show Stream Selection' => 'Afficher la séléction du point de montage',
      'Layout' => 'Mise en page',
      'Layout Style' => 'Style de mise en page',
      'Width (px or %)' => 'Longueur (px ou %)',
      'Height (px)' => 'Hauteur (px)',
      'Enable Popup Player' => 'Activer le lecteur popup',
      'Continuous Play Across Pages' => 'Lecture continue sur toutes les pages',
      'Custom CSS' => 'CSS personnalisé',
      'Additional CSS to customize the widget appearance' => 'CSS supplémentaire pour customiser l\'apparence du widget',
      'Embed Code' => 'Code d\'intégration',
      'Live Preview' => 'Apercu en temps réel',
      ...
      'Load saved template...' => 'Charger le modèle enregistré...',
      'Delete template' => 'Supprimer le modèle',
      'Template Management' => 'Gestion du modèle',
      'Export All' => 'Tout exporter',
      'Import' => 'Importer',
      'Failed to import template file. Please check the file format.' => 'Impossible d\'importer le fichier de modèles. Veuillez vérifier le format du fichier.',
      ...
      'Min. Connected Time' => 'Temps min. connecté',
      'Max. Connected Time' => 'Temps max. connecté',
      ...
      'There is no Stereo Tool configuration file present.' => 'Il n\'y a pas de fichier de configuration Stereo Tool présent.',
      ...
      'Streamer Broadcast' => 'Diffusions du streamer/DJ
',
      'Delete Broadcast?' => 'Supprimer la diffusion ?',
      'Delete %{num} broadcasts?' => 'Supprimer %{num} enregistrements ?',
      'Broadcasts removed:' => 'Émissions supprimées :',
      'Error removing broadcasts:' => 'Erreur en supprimant les émissions :',
      ...
      'Webhook duplicated.' => 'Webhook dupliqué.',
      ...
      'Select the event(s) that will trigger this webhook. If no events are selected, the webhook will run for all applicable events.' => 'Sélectionnez le(s) événement(s) qui déclencheront ce webhook. Si aucun événement n\'est sélectionné, le webhook s\'exécutera pour tous les événements applicables.',
      'Only Trigger Once Every...' => 'Poster seulement une fois tous les...',
      'Use this setting to limit the rate of web hooks sent by the system. This can be useful to avoid rate limits on third party services.' => 'Utilisez ce paramètre pour limiter le débit des webhooks envoyés par AzuraCast. Cela peut être utile pour éviter les banissement temporaires sur les services tiers.',
      '%{seconds} seconds' => '%{seconds} secondes',
      '%{minutes} minutes' => '%{minutes} minutes',
      '%{hours} hours' => '%{hours} heures',
      'No Limit' => 'Aucune limite',
      'Bluesky Handle' => 'Bluesky Handle',
      'The username associated with your account.' => 'Le nom d\'utilisateur associé à votre compte.',
      'App Password' => 'Mot de passe de l\'application',
      'Create a new App Password for this service, then enter the key here (i.e. 0123-abcd-4567)' => 'Créez un nouveau mot de passe pour ce service, puis saisissez la clé ici (par exemple 0123-abcd-4567)',
      ...
      'Embed Color (Hex)' => 'Couleur de l\'embed (hex)',
      'Include Timestamp' => 'Inclure l\'horodatage',
      'If set, the time sent will be included in the embed footer.' => 'Si défini, l\'heure envoyée sera incluse dans le pied de page de l\'embed.',
      ...
      'Now playing on %{station}: %{title} by %{artist}! Tune in now: %{url}' => 'En cours de lecture sur %{station} : %{title} de %{artist} ! Rendez-vous sur : %{url}',
      'Now playing on %{station}: %{title} by %{artist} with your host, %{dj}! Tune in now: %{url}' => 'En cours de lecture sur %{station} : %{title} de %{artist} avec votre animateur, %{dj} ! Rendez-vous sur : %{url}',
      '%{dj} is now live on %{station}! Tune in now: %{url}' => '%{dj} est maintenant en direct sur %{station} ! Rendez-vous sur : %{url}',
      'Thanks for listening to %{station}!' => 'Bonne écoute sur %{station} !',
      '%{station} is going offline for now.' => '%{station} est hors ligne pour le moment.',
      '%{station} is back online! Tune in now: %{url}' => '%{station} est de nouveau en ligne ! Rendez-vous sur : %{url}',
      'Now playing on %{station}:' => 'En cours de lecture sur %{station} :',
      'Powered by AzuraCast' => 'Fièrement propulsé par AzuraCast',
      'Now playing on %{station}: %{title} by %{artist}! Tune in now.' => 'En cours de lecture sur %{station} : %{title} de %{artist} avec votre animateur, %{dj} !',
      ...
      'This can be generated in the &quot;Events&quot; section for a measurement.' => 'Cela peut être généré dans la section "Événements" d\'un flux de données.',
      'Measurement ID' => 'ID de mesure',
      'A unique identifier (i.e. &quot;G-A1B2C3D4&quot;) for this measurement stream.' => 'Un identifiant unique (ex. "G-A1B2C3D4") pour ce flux de mesure.',
      'Bot ID' => 'ID du bot',
      'See the GroupMe Documentation for more details.' => 'Voir la documentation GroupMe pour plus de détails.',
      'Custom API Base URL' => 'URL de base de l\'API personnalisée',
      'Leave blank to use the default GroupMe API URL (recommended).' => 'Laissez vide pour utiliser l\'URL par défaut de l\'API GroupMe (recommandée).',
      ...
      'Found under the settings page for the corresponding RadioReg station.' => 'Vous pouvez le trouver dans la page des paramètres de la station RadioReg correspondante.',
      'RadioReg Organization API Key' => 'Clé API de l\'organisation RadioReg',
      'An API token is issued on a per-organization basis and are found on the org. settings page.' => 'Un jeton API est émis sur une base par organisation et se trouve sur la page des paramètres de l\'organisation.',
      ...
      'GroupMe Chat Message' => 'Message du t\'chat GroupMe',
      'Use the GroupMe Bot API to send a message to a channel.' => 'Utiliser l\'API du bot GroupMe pour envoyer un message à un canal.',
      ...
      'Automatically publish to Bluesky.' => 'Automatiquement publier sur Bluesky.',
      ...
      'This field must be a valid, non-transparent 6-character hex color.' => 'Ce champ doit être une couleur hexadécimale de 6 caractères valide (sans transparence).',
      ...
      'AzuraCast Common Liquidsoap Functions' => 'Fonctions communes de Liquidsoap d\'AzuraCast',
      'AutoCue Liquidsoap Functions' => 'Fonctions d\'AutoCue de Liquidsoap',
      ...
      'Unable to create a new stream, station\'s maximum HLS streams reached.' => 'Impossible de créer un nouveau flux, les flux HLS maximaux de la station ont été atteints.',
      ...
      'You have submitted a request too recently! Please wait %d minutes before submitting another one.' => 'Vous avez fait une requète trop récemment ! Veuillez patienter %d minutes avant d\'en soumettre un autre.',
      'Your request has been submitted and will be played soon.' => 'Votre demande a été soumise et sera bientôt jouée.',
      '%d files will be modified.' => '%d fichiers vont être modifiés.',
      ...
      'Unable to create a new mount point, station\'s maximum mount points reached.' => 'Impossible de créer un nouveau point de montage, les points de montage maximaux de la station ont été atteints.',
      ...
      'Logged in using login token.' => 'Connecté en utilisant le jeton de connexion.',
      ...
      'Delete Station Media' => 'Supprimer les fichiers médias de la station',
      ...
      'RSAS Access Log' => 'Logs d\'accès RSAS',
      'RSAS Error Log' => 'Logs d\'erreur RSAS',
      'RSAS Configuration' => 'Configuration de RSAS',
      ...
      'The locale to use for CLI commands' => 'Lieu à utiliser pour les commandes CLI',
      'The application environment' => 'Environnement de l\'application',
      'Manually modify the logging level' => 'Modifier manuellement le niveau de journalisation',
      ...
      'This allows you to debug Slim Application Errors you may encounter. By default, this is disabled to prevent users from seeing privileged information. Please report any Slim Application Error logs to the development team on GitHub.' => 'Cela vous permet de déboguer les erreurs de Slim Application que vous pouvez rencontrer. Par défaut, cela est désactivé pour empêcher les utilisateurs de voir des informations privilégiées. Veuillez signaler tous les journaux d\'erreurs de Slim Application à l\'équipe de développement sur GitHub.',
      ...
      'Redis DB (Recommended to Use Default)' => 'BDD Redis (recommandé)',
      ...
      'The delay (in seconds) between Now Playing checks for every station. Decrease for more frequent checks at the expense of performance; increase for less frequent checks but better performance (for large installations).' => 'Le délai (en secondes) pour vérifier le Now Playing entre chaque station. Diminuer pour des vérifications plus fréquentes au détriment des performances; augmenter pour des vérifications moins fréquentes mais pour des meilleures performances (pour les grandes installations).',
      ...
      'Automatically block common bots and crawlers' => 'Bloquer automatiquement les robots et les crawlers communs',
      'If enabled, this will automatically download and update the Ultimate Nginx Bad Bot Blocker, which will block aggressive crawlers and other bots.' => 'Si cette option est activée, elle téléchargera et mettra automatiquement à jour Ultimate Nginx Bad Bot Blocker, qui bloquera les crawlers agressifs et autres robots.',
      ...
      'The selected bitrate: %selected_bitrate%, is higher than the station\'s bitrate limit:  %station_limit%' => 'Le débit sélectionné %selected_bitrate%, est plus élevé que la limite de débit binaire de la station %station_limit%',
      'Select...' => 'Sélectionner ...',
      ...
      'The port %s is in use by another station (%s).' => 'Le port %s est déjà utilisé par une autre station (%s).',
