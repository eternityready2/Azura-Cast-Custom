<?php return array (
  ...
  array (
    ...
    array (
      ...
      'Note that restoring a backup will clear your existing database. Never restore backup files from untrusted users.' => '참고: 백업을 복원하면 기존 데이터베이스가 정리됩니다. 신뢰할 수 없는 사용자로부터 백업 파일을 복원하지 마세요.',
      'Backups' => '백업',
      ...
      'Backup times are always in UTC.' => '백업 시간은 항상 UTC 기준입니다.',
      ...
      'ZStandard compression' => 'ZStandard 압축',
      ...
      'Clear Server Cache' => '서버 캐시 비우기',
      'Clear Client Cache' => '클라이언트 캐시 비우기',
      ...
      'Next Run' => '다음 실행',
      'Manual Only' => '수동 전용',
      'Client-side cache cleared!' => '클라이언트 측 캐시가 비워졌습니다!',
      'Details' => '세부정보',
      'Debug' => '디버그',
      'Info' => '정보',
      'Notice' => '공지',
      ...
      'IP Geolocation is used to guess the approximate location of your listeners based on the IP address they connect with. Use the free built-in IP Geolocation library or enter a license key on this page to use MaxMind GeoLite.' => 'IP 위치정보는 청취자가 연결된 IP 주소를 기반으로 청취자의 대략적인 위치를 추측하는 데 사용됩니다. 무료로 내장된 IP Geolocation 라이브러리를 사용하거나 이 페이지에 라이선스 키를 입력하여 MaxMind GeoLite를 사용하세요.',
      'Instructions' => '지침',
      'AzuraCast ships with a built-in free IP geolocation database. You may prefer to use the MaxMind GeoLite service instead to achieve more accurate results. Using MaxMind GeoLite requires a license key, but once the key is provided, we will automatically keep the database updated.' => 'AzuraCast에는 무료 IP 지리 위치 데이터베이스가 내장되어 있습니다. 보다 정확한 결과를 얻으려면 대신 MaxMind GeoLite 서비스를 사용하는 것이 좋습니다. MaxMind GeoLite를 사용하려면 라이선스 키가 필요하지만 키가 제공되면 자동으로 데이터베이스가 업데이트됩니다.',
      ...
      'Visit the "My License Key" page under the "Services" section.' => '"서비스(Services)" 섹션 아래의 "내 라이선스 키(My License Key)" 페이지를 방문하세요.',
      'Click "Generate new license key".' => '"새 라이선스 키 생성(Generate new license key)"을 클릭하세요.',
      'Paste the generated license key into the field on this page.' => '생성된 라이선스 키를 이 페이지의 필드에 붙여넣으세요.',
      ...
      'Remove GeoLite license key?' => 'GeoLite 라이선스 키를 제거하시겠습니까?',
      'Administration' => '관리',
      'Server Status' => '서버 상태',
      ...
      'Rocket Streaming Audio Server (RSAS)' => '로켓 스트리밍 오디오 서버(RSAS)',
      'Stereo Tool' => 'Stereo Tool',
      'MaxMind GeoLite IP Database' => 'MaxMind GeoLite IP 데이터베이스',
      ...
      'Install RSAS' => 'RSAS 설치',
      'Rocket Streaming Audio Server (RSAS) is a closed-source alternative to Icecast as a broadcasting frontend. As it is proprietary, AzuraCast cannot distribute it, but you can install it via this page. If installed, stations can select it as their broadcasting software.' => '로켓 스트리밍 오디오 서버(RSAS)는 방송 프런트엔드로서 아이스캐스트에 대한 폐쇄 소스 대안이다. AzuraCast는 독점이기 때문에 배포할 수 없지만 이 페이지를 통해 설치할 수 있습니다. 설치된 경우 방송국은 이를 방송 소프트웨어로 선택할 수 있습니다.',
      'In order to install RSAS:' => 'RSAS를 설치하려면:',
      'Download the proper statically linked binary for your platform from the RSAS download page:' => 'RSAS 다운로드 페이지에서 플랫폼에 적합한 정적으로 연결된 바이너리를 다운로드하세요:',
      'Download RSAS' => 'RSAS로 다운로드',
      ...
      'If using the paid version of RSAS, upload the license key file separately.' => 'RSAS의 유료 버전을 사용하는 경우 라이선스 키 파일을 별도로 업로드하세요.',
      'RSAS is not currently installed on this installation.' => 'RSAS는 현재 이 설치에 설치되어 있지 않습니다.',
      'Uninstall' => '제거',
      'License Key' => '라이선스 키',
      'License key is currently installed.' => '라이선스 키가 현재 설치되어 있습니다.',
      'License key is not is not currently installed.' => '라이선스 키가 현재 설치되어 있지 않습니다.',
      'Remove License Key' => '라이선스 키 제거',
      'RSAS version "%{version}" is currently installed.' => 'RSAS 버전 "%{version}"이 현재 설치되어 있습니다.',
      'Remove RSAS installation?' => 'RSAS 설치를 제거하시겠습니까?',
      'Remove RSAS license key?' => 'RSAS 라이선스 키를 제거하시겠습니까?',
      'Debugging' => '디버깅',
      'Temporarily Disable Synchronization Tasks' => '동기화 작업을 일시적으로 비활성화합니다',
      'Prevents background tasks from automatically running. Tasks are disabled automatically when restoring a backup to allow media to be re-uploaded.' => '백그라운드 작업이 자동으로 실행되는 것을 방지합니다. 백업 복원 시 미디어를 다시 업로드할 수 있도록 작업이 자동으로 비활성화됩니다.',
      'Settings' => '설정',
      ...
      'Shoutcast version "%{version}" is currently installed.' => 'Shoutcast 버전 "%{version}"이 현재 설치되어 있습니다.',
      'Remove Shoutcast 2 DNAS?' => 'Shoutcast 2 DNAS를 제거하시겠습니까?',
      'Manage' => '관리',
      'Clone' => '복제',
      'Enable' => '활성화',
      'Broadcasting' => '방송',
      ...
      'Maximum Bitrate' => '최대 비트레이트',
      'The maximum bitrate in which the station allowed to broadcast at, in Kbps. 0 for unlimited.' => '스테이션에서 방송이 허용된 최대 비트 전송률(Kbps)입니다. 무제한의 경우 0입니다.',
      'Maximum Mounts' => '최대 마운트',
      'The maximum number of mount points allowed. 0 for unlimited.' => '허용되는 최대 마운트 지점 수입니다. 무제한의 경우 0입니다.',
      'Maximum HLS Streams' => '최대 HLS 스트림',
      'The maximum number of HLS streams allowed. 0 for unlimited.' => '허용되는 최대 HLS 스트림 수입니다. 무제한의 경우 0입니다.',
      ...
      'Provide a valid license key from Thimeo. Functionality is limited without a license key.' => 'Thimeo에서 발급한 유효한 라이선스 키를 제공하십시오. 라이선스 키가 없으면 기능이 제한됩니다.',
      ...
      'Advanced' => '고급',
      'Share Encoders Between Streams' => '스트림 간 인코더 공유',
      'If you have multiple streams that broadcast in the same format and bitrate, enabling this may significantly improve CPU consumption. Disable this setting if you encounter issues with shared encoding.' => '동일한 형식과 비트레이트로 방송하는 스트림이 여러 개인 경우, 이 기능을 활성화하면 CPU 사용량이 크게 개선될 수 있습니다. 공유 인코딩 관련 문제가 발생하는 경우 이 설정을 비활성화하세요.',
      ...
      'Leave blank to automatically generate a new password.' => '새 암호를 자동으로 생성하려면 비워 두세요.',
      ...
      'Use Rocket Streaming Audio Server (RSAS) on this server.' => '이 서버에서 RSAS(Rocket Streaming Audio Server)를 사용합니다.',
      ...
      'Description' => '설명',
      'Genre' => '장르',
      'The primary genre this station plays, such as "rock", "electronic", or "talk".' => '\'록\', \'일렉트로닉\', \'토크\' 등 현재 스테이션에서 재생하는 기본 장르입니다.',
      ...
      'Stereo Tool version %{version} is currently installed.' => 'Stereo Tool 버전 %{version}이 현재 설치되어 있습니다.',
      'Uninstall Stereo Tool?' => 'Stereo Tool을 제거하시겠습니까?',
      ...
      'Password' => '암호',
      'Leave blank to use the current password.' => '현재 암호를 사용하려면 비워 두세요.',
      'Display Name' => '표시 이름',
      'Edit User' => '사용자 편집',
      'New Login Link' => '새 로그인 링크',
      'Link Type' => '링크 유형',
      'Link Expiration (Minutes)' => '링크 만료 시간(분)',
      'Description/Comments' => '설명/의견',
      'Create New Login Link' => '새 로그인 링크 생성',
      'Reset Password' => '암호 재설정',
      'Magic Login Link' => '매직 로그인 링크',
      'New Login Link Created' => '새 로그인 링크 생성됨',
      'Important: copy the address before continuing!' => '중요: 계속 진행하기 전에 주소를 복사하세요!',
      'Each login link is only usable once.' => '각 로그인 링크는 한 번만 사용할 수 있습니다.',
      ...
      'Avatars are retrieved based on your e-mail address from the %{service} service. Click to manage your %{service} settings.' => '%{service} 서비스에서 이메일 주소를 기반으로 아바타를 가져옵니다. %{service} 설정을 관리하려면 클릭하세요.',
      'Enabled' => '활성화',
      'Running' => '실행 중',
      'Not Running' => '실행되지 않음',
      'Hour' => '시간',
      ...
      'Schedule' => '일정',
      'Microphone' => '마이크',
      'Disable Microphone' => '마이크 비활성화',
      'Enable Microphone' => '마이크 활성화',
      'Cue' => '큐',
      ...
      'Web DJ connected!' => 'Web DJ 연결됨!',
      'An error occurred with the Web DJ socket.' => 'Web DJ 소켓에서 오류가 발생했습니다.',
      ...
      'This will be shown on public player pages if the station is offline. Leave blank to default to a localized version of &quot;%{message}&quot;.' => '스테이션이 오프라인 상태일 경우 이 메시지가 공개 플레이어 페이지에 표시됩니다. 비워두면 기본값으로 현지화된 &quot;%{message}&quot;가 표시됩니다.',
      ...
      'Preview Changes' => '변경 사항 미리 보기',
      'Media File' => '미디어 파일',
      'Proposed Changes' => '제안된 변경 사항',
      'Metadata:' => '메타데이터:',
      'Extra Metadata:' => '추가 메타데이터:',
      'Playlists:' => '재생 목록:',
      'Add to:' => '다음에 추가:',
      'Remove from:' => '다음에서 제거:',
      'Custom Fields:' => '사용자 지정 필드:',
      'No changes' => '변경 사항 없음',
      'Proceed with Import' => '가져오기 진행',
      ...
      'Export Configuration' => '구성 내보내기',
      'Import Configuration' => '구성 가져오기',
      'Select File to Import' => '가져올 파일 선택',
      'Import a file that was previously exported by this page, and AzuraCast will update any custom code sections with the custom code contained in your export file. Note that this will remove any existing code you have in these sections.' => '이 페이지에서 이전에 내보낸 파일을 가져오면 AzuraCast가 내보낸 파일에 포함된 사용자 지정 코드로 모든 사용자 지정 코드 섹션을 업데이트합니다. 이 경우 해당 섹션에 있는 기존 코드는 모두 삭제됩니다.',
      ...
      'The time period that the song should fade in. Leave blank to use the system default.' => '노래가 페이드 인 되는 시간. 시스템 기본값을 사용하려면 공백으로 두세요.',
      'Custom Fading: Fade-Out Time (seconds)' => '사용자 지정 페이딩：페이드 아웃 시간 (초)',
      'The time period that the song should fade out. Leave blank to use the system default.' => '노래가 페이드 아웃 되는 시간. 시스템 기본값을 사용하려면 공백으로 두세요.',
      ...
      'Song Album' => '노래 앨범',
      'Song Lyrics' => '노래 가사',
      'International Standard Recording Code, used for licensing reports.' => '국제 표준 기록 코드는 라이선스 보고서에 사용됩니다.',
      ...
      'This playlist is assigned from the folder %{folder}. Click to view tracks in playlist' => '이 재생 목록은 %{folder} 폴더에서 가져왔습니다. 재생 목록의 트랙을 보려면 클릭하세요',
      ...
      'Overview' => '개요',
      'Edit Station Settings' => '스테이션 설정 편집',
      'Branding' => '브랜딩',
      'Public Player' => '공개 플레이어',
      'Media' => '미디어',
      ...
      'You can include any special mount point settings here, in either JSON { key: \'value\' } format or XML &lt;key&gt;value&lt;/key&gt;' => '여기에 JSON { key: \'value\' } 형식 또는 XML &lt;key&gt;value&lt;/key&gt; 형식으로 특수 마운트 지점 설정을 포함할 수 있습니다.',
      ...
      'Prioritize over listener requests.' => '청취자 요청보다 우선합니다.
',
      ...
      'An optional description to help identify this playlist.' => '이 재생 목록을 식별하는 데 도움이 되는 선택적 설명입니다.',
      'Source' => '소스',
      ...
      'Playlists with larger number weights (i.e. 25) play more frequently than playlists with smaller number weights (i.e. 1).' => '숫자 가중치가 큰 재생 목록(예: 25)은 숫자 가중치가 작은 재생 목록(예: 1)보다 더 자주 재생됩니다.',
      'Once per x Songs' => '노래 x 개당 한 번',
      'Number of Songs Between Plays' => '재생 간 노래 수',
      'This playlist will play every $x songs, where $x is specified here.' => '이 재생 목록은 노래 $x 개마다 재생됩니다. 여기서 $x 은(는) 여기에 지정됩니다.',
      'Once per x Minutes' => 'x 분당 한 번',
      'Number of Minutes Between Plays' => '분당 재생 간격',
      'This playlist will play every $x minutes, where $x is specified here.' => '이 재생 목록은 $x 분마다 재생됩니다. 여기서 $x 은(는) 여기에 지정됩니다.',
      'Once per Hour' => '시간 마다',
      ...
      'Play once every $x songs.' => '노래 $x 개마다 한 번씩 재생합니다.',
      'Play once every $x minutes.' => '$x 분마다 한 번씩 재생합니다.',
      ...
      'Leave blank to play on every day of the week.' => '매일 재생하려면 공백으로 두세요.',
      'Monday' => '월요일',
      'Tuesday' => '화요일',
      'Wednesday' => '수요일',
      'Thursday' => '목요일',
      ...
      'Indicates the presence of explicit content (explicit language or adult content). Apple Podcasts displays an Explicit parental advisory graphic for your podcast if turned on. Podcasts containing explicit material aren\'t available in some Apple Podcasts territories.' => '노골적인 콘텐츠(욕설 또는 성인 콘텐츠)가 포함되어 있음을 나타냅니다. Apple Podcasts는 이 기능을 활성화하면 팟캐스트에 \'노골적인 콘텐츠 시청 주의\' 그래픽을 표시합니다. 일부 Apple Podcasts 서비스 지역에서는 노골적인 콘텐츠가 포함된 팟캐스트를 이용할 수 없습니다.',
      'Enable Open Podcast Prefix Project (OP3) Analytics Support' => 'OP3(Open Podcast Prefix Project) 분석 지원 활성화',
      'Enable to prefix all podcast episode URLs with the OP3 analytics URL, allowing you to view statistics about your podcast audience via the OP3 service.' => '모든 팟캐스트 에피소드 URL에 OP3 분석 URL을 접두사로 붙이면 OP3 서비스를 통해 팟캐스트 청취자에 대한 통계를 볼 수 있습니다.',
      ...
      'Start' => '시작',
      'Restart service?' => '서비스를 다시 시작하시겠습니까?',
      'Start service?' => '서비스를 시작하시겠습니까?',
      'Stop service?' => '서비스를 중지하시겠습니까?',
      ...
      'Skip current song?' => '현재 노래를 건너뛰시겠습니까?',
      'Disconnect current streamer?' => '현재 스트리머를 연결 해제하시겠습니까?',
      ...
      'Enable feature?' => '기능을 활성화하시겠습니까?',
      'Disable feature?' => '기능을 비활성화하시겠습니까?',
      'Player Embed Widget Builder' => '플레이어 임베드 위젯 빌더',
      'Widget Builder' => '위젯 빌더',
      'Reset All To Defaults' => '모두 기본값으로 재설정',
      'Widget Type' => '위젯 종류',
      'Theme' => '테마',
      'Player Customization' => '플레이어 사용자 지정',
      'Appearance' => '외관',
      'Primary Color' => '기본 색상',
      'Background Color' => '배경 색상',
      'Text Color' => '텍스트 색상',
      'Show Album Art' => '앨범 아트 보기',
      'Rounded Corners' => '둥근 모서리',
      'Functionality' => '기능성',
      'Initial Volume' => '초기 볼륨',
      'Autoplay' => '자동 재생',
      'Show Volume Controls' => '볼륨 컨트롤 표시',
      'Show Track Progress' => '트랙 진행 상황 표시',
      'Show Stream Selection' => '스트림 선택 표시',
      'Layout' => '레이아웃',
      'Layout Style' => '레이아웃 스타일',
      'Width (px or %)' => '너비(픽셀 또는 %)',
      'Height (px)' => '높이(픽셀)',
      'Enable Popup Player' => '팝업 플레이어 활성화',
      'Continuous Play Across Pages' => '페이지 간 연속 재생',
      'Custom CSS' => '사용자 지정 CSS',
      'Additional CSS to customize the widget appearance' => '위젯 모양을 사용자 지정하기 위한 추가 CSS',
      'Embed Code' => '임베드 코드',
      ...
      'Load saved template...' => '저장된 템플릿 불러오기...',
      'Delete template' => '템플릿 삭제',
      'Template Management' => '템플릿 관리',
      'Export All' => '모두 내보내기',
      'Import' => '가져오기',
      'Failed to import template file. Please check the file format.' => '템플릿 파일을 가져오는 데 실패했습니다. 파일 형식을 확인해 주세요.',
      ...
      'Name/Type' => '이름/유형',
      'Triggers' => '트리거',
      'Webhook duplicated.' => '웹훅이 복제되었습니다.',
      ...
      'Select the event(s) that will trigger this webhook. If no events are selected, the webhook will run for all applicable events.' => '이 웹훅을 트리거할 이벤트를 선택하세요. 이벤트를 선택하지 않으면 해당되는 모든 이벤트에 대해 웹훅이 실행됩니다.',
      'Only Trigger Once Every...' => '매 회마다 한 번만 트리거됩니다...',
      'Use this setting to limit the rate of web hooks sent by the system. This can be useful to avoid rate limits on third party services.' => '이 설정을 사용하면 시스템에서 보내는 웹훅의 속도를 제한할 수 있습니다. 이는 타사 서비스의 속도 제한을 피하는 데 유용할 수 있습니다.',
      '%{seconds} seconds' => '%{seconds}초',
      '%{minutes} minutes' => '%{minutes}분',
      '%{hours} hours' => '%{hours}시간',
      'No Limit' => '제한 없음',
      'Bluesky Handle' => 'Bluesky 핸들',
      'The username associated with your account.' => '귀하의 계정과 연결된 사용자 이름입니다.',
      'App Password' => '앱 암호',
      'Create a new App Password for this service, then enter the key here (i.e. 0123-abcd-4567)' => '이 서비스에 대한 새 앱 암호를 생성한 다음 여기에 키를 입력하세요. (예: 0123-abcd-4567)',
      ...
      'Footer Text' => '꼬리말',
      'Embed Color (Hex)' => '색상 삽입(16진수)',
      'Include Timestamp' => '타임스탬프 포함',
      'If set, the time sent will be included in the embed footer.' => '이 옵션을 설정하면 전송된 시간이 내장 푸터에 포함됩니다.',
...
',
      ...
      'This can be generated in the &quot;Events&quot; section for a measurement.' => '이는 측정의 &quot;이벤트&quot; 섹션에서 생성할 수 있습니다.',
      'Measurement ID' => '측정 ID',
      'A unique identifier (i.e. &quot;G-A1B2C3D4&quot;) for this measurement stream.' => '이 측정 스트림에 대한 고유 식별자(예: &quot;G-A1B2C3D4&quot;)입니다.',
      'Bot ID' => '봇 ID',
      'See the GroupMe Documentation for more details.' => '자세한 내용은 GroupMe 문서를 참조하세요.',
      'Custom API Base URL' => '사용자 지정 API 기본 URL',
      'Leave blank to use the default GroupMe API URL (recommended).' => '기본 GroupMe API URL을 사용하려면 비워 두세요(권장).',
      ...
      'If your Mastodon username is &quot;@test@example.com&quot;, enter &quot;example.com&quot;.' => '마스토돈 사용자 이름이 &quot;@test@example.com&quot;인 경우 &quot;example.com&quot;을 입력하세요.',
      'Access Token' => '액세스 토큰',
      ...
      'Found under the settings page for the corresponding RadioReg station.' => '해당 RadioReg 스테이션의 설정 페이지에서 찾을 수 있습니다.',
      'RadioReg Organization API Key' => 'RadioReg 조직 API 키',
      'An API token is issued on a per-organization basis and are found on the org. settings page.' => 'API 토큰은 조직별로 발행되며 조직 설정 페이지에서 찾을 수 있습니다.',
      'Bot Token' => '봇 토큰',
      ...
      'GroupMe Chat Message' => 'GroupMe 대화 메시지',
      'Use the GroupMe Bot API to send a message to a channel.' => 'GroupMe 봇 API를 사용하여 채널에 메시지를 보냅니다.',
      'Mastodon Post' => 'Mastodon 포스트',
      'Automatically publish to a Mastodon instance.' => 'Mastodon 인스턴스에 자동으로 게시합니다.',
      'Bluesky Post' => 'Bluesky 포스트',
      'Automatically publish to Bluesky.' => '자동으로 Bluesky에 게시합니다.',
      ...
      'This field must be a valid, non-transparent 6-character hex color.' => '이 필드는 유효하고 투명하지 않은 6자리 16진수 색상이어야 합니다.',
      ...
      'AzuraCast Common Liquidsoap Functions' => 'AzuraCast 일반 Liquidsoap 기능',
      'AutoCue Liquidsoap Functions' => 'AutoCue Liquidsoap 기능',
      ...
      'Unable to create a new stream, station\'s maximum HLS streams reached.' => '새 스트림을 생성할 수 없습니다. 스테이션의 최대 HLS 스트림에 도달했습니다.',
      'Station Nginx Configuration' => '스테이션 Nginx 구성',
      'This station is out of available storage space.' => '이 스테이션에는 사용 가능한 저장 공간이 없습니다.',
      'Web hook enabled.' => '웹훅 활성화됨.',
      'Web hook disabled.' => '웹훅 비활성화됨.',
      ...
      'This song or artist has been played too recently. Wait a while before requesting it again.' => '이 노래나 아티스트가 너무 최근에 재생되었습니다. 다시 요청하기 전에 잠시 기다리세요.',
      'You have submitted a request too recently! Please wait %d minutes before submitting another one.' => '너무 최근에 요청을 제출하셨습니다! 다음 요청을 제출하기 전에 %d분 동안 기다려 주세요.',
      'Your request has been submitted and will be played soon.' => '귀하의 요청이 제출되었으며 곧 재생됩니다.',
      '%d files will be modified.' => '%d개의 파일이 수정됩니다.',
      ...
      'Unable to create a new mount point, station\'s maximum mount points reached.' => '새 마운트 지점을 생성할 수 없습니다. 스테이션의 최대 마운트 지점에 도달했습니다.',
      ...
      'Logged in using login token.' => '로그인 토큰을 사용하여 로그인했습니다.',
      ...
      'Delete Station Media' => '스테이션 미디어 제거',
      ...
      'Welcome to AzuraCast. Please wait while some key dependencies of AzuraCast are set up...' => 'AzuraCast에 오신 것을 환영합니다. AzuraCast의 일부 주요 종속성을 설정하는 동안 잠시 기다려 주세요...',
      ...
      'Please wait while a backup is generated...' => '백업이 생성되는 동안 잠시 기다려 주세요...',
      ...
      'RSAS Access Log' => 'RSAS 액세스 로그',
      'RSAS Error Log' => 'RSAS 오류 로그',
      'RSAS Configuration' => 'RSAS 구성',
      ...
      'The locale to use for CLI commands' => 'CLI 명령에 사용할 로케일',
      'The application environment' => '애플리케이션 환경',
      'Manually modify the logging level' => '로깅 수준을 수동으로 수정',
      ...
      'This allows you to debug Slim Application Errors you may encounter. By default, this is disabled to prevent users from seeing privileged information. Please report any Slim Application Error logs to the development team on GitHub.' => '이를 통해 발생할 수 있는 Slim 앱 오류를 디버깅할 수 있습니다. 기본적으로 이 기능은 사용자가 권한 있는 정보를 보지 못하도록 비활성화되어 있습니다. Slim 앱 오류 로그를 GitHub의 개발 팀에 보고해 주세요.',
      'MariaDB Host' => 'MariaDB 호스트',
      'Do not modify this after installation.' => '설치 후에는 이를 수정하지 마세요.',
      ...
      'Log slower queries to diagnose possible database issues. Only turn this on if needed.' => '가능한 데이터베이스 문제를 진단하기 위해 느린 쿼리를 기록합니다. 필요한 경우에만 이 기능을 켜세요.',
      ...
      'Redis Port' => 'Redis 포트',
      'Redis DB (Recommended to Use Default)' => 'Redis DB (기본값 사용을 권장함)',
      ...
      'The delay (in seconds) between Now Playing checks for every station. Decrease for more frequent checks at the expense of performance; increase for less frequent checks but better performance (for large installations).' => '모든 스테이션에 대한 "지금 재생 중" 확인 사이의 지연 시간(초). 성능을 희생하여 더 자주 확인하는 경우 감소합니다. 덜 자주 확인하는 경우 더 나은 성능을 위해 증가합니다(대규모 설치의 경우).',
      ...
      'Automatically block common bots and crawlers' => '일반적인 봇과 크롤러를 자동으로 차단합니다.',
      'If enabled, this will automatically download and update the Ultimate Nginx Bad Bot Blocker, which will block aggressive crawlers and other bots.' => '활성화되면 Ultimate Nginx Bad Bot Blocker가 자동으로 다운로드 및 업데이트되어 공격적인 크롤러 및 기타 봇을 차단합니다.',
      ...
      '(Docker Compose) All Docker containers are prefixed by this name. Do not change this after installation.' => '(Docker Compose) 모든 Docker 컨테이너에는 이 이름이 앞에 붙습니다. 설치 후에는 이를 변경하지 마세요.',
      ...
      'The selected bitrate: %selected_bitrate%, is higher than the station\'s bitrate limit:  %station_limit%' => '선택한 비트 전송률: %selected_bitrate%은 스테이션의 비트 전송률 제한: %station_limit%보다 높습니다.',
      'Select...' => '선택...',
