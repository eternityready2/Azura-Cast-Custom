...
final class Version20260426132842 extends AbstractMigration
{
    ...
    {
        $this->addSql('ALTER TABLE station ADD requests_only_via_playlists TINYINT NOT NULL DEFAULT 0');
        $this->addSql('ALTER TABLE station_schedules ADD prevent_requests TINYINT NOT NULL DEFAULT 0');
    }
