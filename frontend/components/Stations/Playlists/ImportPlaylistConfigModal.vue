    ...
    >
        <div v-if="results">
            ...
            <ul class="list-unstyled">
                ...
                <li>{{ $gettext('Smart Block criteria created:') }} {{ results.smart_block_criteria_created }}</li>
            </ul>
        ...
        >
            <form-group id="import_playlist_config_modal_file">
                ...
                <template #description>
                    {{
                        $gettext('New playlists are created from the configuration. Existing media is re-linked where possible; missing referenced media can be generated as placeholders so playlist structure is preserved.')
                    }}
                </template>
...
type ConfigImportResult = Required<ApiStatus> & {
    ...
    smart_block_criteria_created: number;
    warnings: string[];
};
